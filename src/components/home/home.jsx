        ...
        <>
            ...
            <section id="services" className='just-col'>
                ...
                <div id="three-services" className='row-to-col flex-evenly'>
                    <div className='service-link'>
                        ...
                        <p className='service-description'>We can make custom furniture for every corner of your home
                            from beds, nightstands, coffee tables, and vanities</p>
                    </div>
                    <div className='service-link'>
                        <a>
                        ...
                        <p className='service-description'>Need your space to be optimized and functional?
                            <br></br>We also specialize in Entertainment centers, California Style Closets, and Kitchens </p>
                    </div>
                    <div className='service-link'>
                        <a>
                        ...
                        <p className='service-description'>We do more than just furnishings and storage.
                            <br></br>We've worked on Bar tops, Barn Doors, Dog kennels, Stove tops, and more</p>
                    </div>
                </div>
            </section >
            ...
            <section className='row-to-col'>
                <div className='half-div about-text'>
                    ...
                    <p>It started off a side business making dining tables and TV console for co workers and friends, turned into a true passion.
                        Just like a lot of people I made a huge change after the pandemic, because I saw corporations have one goal to take care of themselves I realized that’s what I needed to do.
                        I took my talent mixed it with my passion, and my attention to detail, to create this!
                        A small business with big aspirations.
                        I offer the best prices for my clients with the best quality.
                    </p>
                </div>
